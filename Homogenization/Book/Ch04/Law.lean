...
/-- The local-test sigma algebra generated by smooth coefficient averages on
an observation set. -/
...
/-- A law treats local-test events as null-measurable for integration against
the ambient coefficient-field measure. -/
